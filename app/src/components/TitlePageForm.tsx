...
import { SubmissionType, SubmissionParams } from '@/lib/types'
...
const TitlePageForm: React.FC = () => {
    ...
    const handleSubmitterChange = (index: number, field: 'name' | 'usn', value: string) => {
        const newSubmitters = submitters.map((submitter, i) => 
            i === index ? { ...submitter, [field]: value } : submitter
        );
        setSubmitters(newSubmitters);

        const submittersObject = newSubmitters.reduce((acc, submitter) => {
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            onChange={(e) => handleInputChange('semester_number', parseInt(e.target.value))}
                            required
                            min="1"
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => handleInputChange('from_ay', parseInt(e.target.value))}
                                required
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => handleInputChange('to_ay', parseInt(e.target.value))}
                                required
                            />
                        </div>
                    </div>
